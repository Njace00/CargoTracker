...
<head>
    ...
    <style>
        ...
        .submit-button { width: 100%; padding: 15px; font-size: 18px; font-weight: 700; color: #fff; background-color: #009900; border: none; border-radius: 5px; cursor: pointer; }
        ...
        .user-dropdown button { background: transparent; border: none; cursor: pointer; font-size: 16px; font-weight: 500; color: inherit; }
        .user-dropdown-menu { display: none; position: absolute; right: 0; background: white; min-width: 180px; box-shadow: 0 4px 8px rgba(0,0,0,0.1); border-radius: 4px; z-index: 1000; }
        .user-dropdown:hover .user-dropdown-menu { display: block; }
        .logout-btn { width: 100%; padding: 12px 16px; border: none; background: transparent; color: #d9534f; text-align: left; cursor: pointer; }
